...
# final training, validation data related directory and file names
BINARY_DATA_DIR = "dataset"
TAIN_DATA_NAME = "train.spacy"
VALID_DATA_NAME = "valid.spacy"
TEST_DATA_NAME = "test.spacy"
